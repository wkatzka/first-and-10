 ...
 * @returns {string} - 'pass_heavy', 'run_dominant', or 'balanced'
 */
export function detectOffensiveStrategy(cards) {
  ...
  if (qbStyle === 'DUAL_THREAT' || tierRatio < 0.85) return 'run_dominant';
