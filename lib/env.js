...
/** true = show Shop + wallet connect. Enabled by env var or defaults to testing only. */
export const cryptoShopEnabled = 
  process.env.NEXT_PUBLIC_CRYPTO_SHOP_ENABLED === 'true' || 
  (process.env.NEXT_PUBLIC_CRYPTO_SHOP_ENABLED !== 'false' && isTesting);
